        ...
        <Wrapper>
            <Checkbox 
             ...
             checked={ selectedEmails.includes(email._id)}         
                 ...
                 />
                 {
                email.starred ?<Star fontSize ="small" style = {{marginRight: 10, color: 'yellow' }} onClick={()=> toggleStarredMails()} />:   <StarBorder fonstSize='small' style= {{marginRight: 10 }} onClick={() => toggleStarredMails()} />
                 }
